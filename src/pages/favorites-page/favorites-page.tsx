...
import { getOfferCardByCity } from '../../components/utils.ts';
...
function FavoritesPage({ offersData }: OfferProps): JSX.Element {
  const getFavotiteOfferCard = offersData.filter(
    (offerCard: CardProps) => offerCard.isFavorite
  );
        ...
        <div className="page__favorites-container container">
          <section className="favorites">
            ...
            <ul className="favorites__list">
              {Object.entries(offerCardsByCity).map(
                ([cityName, offerCards]) => (
