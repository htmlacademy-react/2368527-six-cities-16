...
import { FormSubmit } from '../../components/review-form/review-form';
          ...
          <div className="offer__container container">
            <div className="offer__wrapper">
              ...
              <div className="offer__name-wrapper">
                <h1 className="offer__name">{correctData?.title}</h1>
              ...
              <div className="offer__rating rating">
                ...
                {correctData && (
                  <div className="offer__stars rating__stars">
                    <span
                      style={{ width: `${(correctData.rating / 5) * 100}%` }}
                    ></span>
              ...
              <ul className="offer__features">
                ...
                <li className="offer__feature offer__feature--bedrooms">
                  {correctData.bedrooms} Bedrooms
                </li>
                <li className="offer__feature offer__feature--adults">
                  Max {correctData.maxAdults} adults
                </li>
              </ul>
                ...
                <div className="offer__host-user user">
                  <div className="offer__avatar-wrapper offer__avatar-wrapper--pro user__avatar-wrapper">
                    <img
                      ...
                      src={correctData.host.avatarUrl}
                      width="74"
                      height="74"
                      alt="Host avatar"
                    />
                  ...
                  <span className="offer__user-name">
                    {correctData.host.name}
                  </span>
                  <span className="offer__user-status">
                    {`${correctData.host.isPro ? 'Pro' : ''}`}
                  </span>
                </div>
                <div className="offer__description">
                  <p className="offer__text">{correctData.description}</p>
                </div>
              </div>
